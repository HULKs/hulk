...
var ui = {
    ...
    snapToGrid: function (x) {
        return Math.round(x / ui.gridsize) * ui.gridsize;
    }
};
...
function Navigation(panels) {
    ...
    var sliderMapper = require('./sliderMapper'); //TODO: circular dependency ui→slidermapper→ui
...
Navigation.prototype.onPanelTypeClick = function (panelType) {
    ...
    var configModal = require('./configDialog');
