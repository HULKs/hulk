var EventEmitter2 = require('./libs/eventemitter2');
...
PanelManager.prototype.openFromJSONString = function (str) {
    ...
    _.each(panelData, function (data) {
        var ctr = require('./globals').panels[data.panel];
...
getPanelName = function (instance) {
    var name = null;
    _.find(require('./globals').panels, function (panel, key) {
