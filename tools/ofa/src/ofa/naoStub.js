...
function Vector2(x,y) { this.val=[x,y] }
Vector2.prototype.toJSON = function() { return this.val };
function Vector3(x,y,z) { this.val=[x,y,z] }
Vector3.prototype.toJSON = function() { return this.val };
