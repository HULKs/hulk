...
pub struct MapPanel {
    ...
    walk_position: EnabledLayer<layers::WalkPosition, Ground>,
}
...
impl<'a> Panel<'a> for MapPanel {
    ...
    fn new(context: PanelCreationContext) -> Self {
        ...
        let walk_position = EnabledLayer::new(context.robot.clone(), context.value, false);
    ...
    fn save(&self) -> Value {
        json!({
            ...
            "walk_position": self.walk_position.save(),
        })
    }
}
    ...
    fn ui(self, ui: &mut Ui) -> eframe::egui::Response {
        ui.horizontal(|ui| {
            ui.menu_button("Overlays", |ui| {
                ...
                self.walk_position.checkbox(ui);
            });
