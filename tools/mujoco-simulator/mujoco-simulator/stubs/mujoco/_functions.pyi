...
def _realloc_con_efc(
    d: mujoco._structs.MjData, ncon: int, nefc: int
) -> None: ...
...
def mj_constraintUpdate(
    ...
    cost: numpy.ndarray[numpy.float64[1, 1], numpy.ndarray.flags.writeable]
    | None,
    flg_coneHessian: int,
) -> None:
    """
...
def mj_solveM2(
    ...
    y: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    sqrtInvD: numpy.ndarray[
        numpy.float64[m, n], numpy.ndarray.flags.c_contiguous
    ],
) -> None:
    """
...
def mju_boxQP(
    ...
    index: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable]
    | None,
...
def mju_sqrMatTD(
    ...
    mat: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    diag: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable]
    | None,
) -> None:
    """
...
def mjv_room2model(
    ...
    modelquat: numpy.ndarray[
        numpy.float64[4, 1], numpy.ndarray.flags.writeable
    ],
