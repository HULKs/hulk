...
static ADD_APT_DDS_ZENOH_BRIDGE_SOURCES: &str = "
...
async fn gammaray_robot(
    ...
    robot
        .ssh_to_robot()?
        .arg(ADD_APT_DDS_ZENOH_BRIDGE_SOURCES)
        .ssh_with_log("adding zenoh-bridge-dds sources", &progress_bar)
        .await?;
    ...
    robot
        ...
        .arg(format!("{}:/etc/zenoh-bridge-dds/", robot.address))
