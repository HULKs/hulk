...
class TriangleMesh:
    ...
    @classmethod
    def create_box(
        cls, width: float, height: float, depth: float, texture_type: mujoco.mjtTexture | None
    ) -> TriangleMesh: ...
    @classmethod
    ...
    @classmethod
    def create_cylinder(
        cls, radius: float, height: float, texture_type: mujoco.mjtTexture | None, resolution: int
    ) -> TriangleMesh: ...
