...
def mj_angmomMat(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    mat: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous],
    body: int,
) -> None:
    """
...
def mj_fullM(
    m: mujoco._structs.MjModel,
    dst: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous],
...
def mj_geomDistance(
    ...
    geom2: int,
    distmax: float,
    fromto: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
) -> float:
    """
...
def mj_jac(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    jacp: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    jacr: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    point: numpy.ndarray[numpy.float64[3, 1]],
    body: int,
) -> None:
    """
...
def mj_jacPointAxis(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    jacPoint: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous]
    | None,
    jacAxis: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    point: numpy.ndarray[numpy.float64[3, 1]],
...
def mj_normalizeQuat(
    m: mujoco._structs.MjModel, qpos: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable]
) -> None:
    """
...
def mj_printFormattedData(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, filename: str, float_format: str
) -> None:
    """
...
def mj_saveModel(
    ...
    buffer: numpy.ndarray[numpy.uint8[m, 1], numpy.ndarray.flags.writeable] | None = None,
) -> None:
    """
...
def mj_setLengthRange(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, index: int, opt: mujoco._structs.MjLROpt
) -> None:
    """
...
def mj_solveM(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    x: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous],
...
def mjd_inverseFD(
    ...
    eps: float,
    flg_actuation: int,
    DfDq: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DfDv: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DfDa: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DsDq: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DsDv: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DsDa: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    DmDq: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
) -> None:
    """
...
def mjd_subQuat(
    ...
    Da: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    Db: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
) -> None:
    """
...
def mjd_transitionFD(
    ...
    eps: float,
    flg_centered: int,
    A: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    B: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    C: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
    D: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous] | None,
) -> None:
    """
...
def mju_addTo(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable], vec: numpy.ndarray[numpy.float64[m, 1]]
) -> None:
    """
    Set res = res + vec.
    """
...
def mju_addTo3(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable], vec: numpy.ndarray[numpy.float64[3, 1]]
) -> None:
    """
    Set res = res + vec.
    """
...
def mju_band2Dense(
    res: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous],
...
def mju_boxQP(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    R: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.writeable, numpy.ndarray.flags.c_contiguous],
...
def mju_copy3(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable], data: numpy.ndarray[numpy.float64[3, 1]]
) -> None:
    """
    Set res = vec.
    """
...
def mju_copy4(
    res: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable], data: numpy.ndarray[numpy.float64[4, 1]]
) -> None:
    """
    Set res = vec.
    """
...
def mju_f2n(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable], vec: numpy.ndarray[numpy.float32[m, 1]]
) -> None:
    """
...
def mju_mat2Quat(
    quat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable], mat: numpy.ndarray[numpy.float64[9, 1]]
) -> None:
    """
...
def mju_muscleBias(
    len: float, lengthrange: numpy.ndarray[numpy.float64[2, 1]], acc0: float, prm: numpy.ndarray[numpy.float64[9, 1]]
) -> float:
    """
...
def mju_n2f(
    res: numpy.ndarray[numpy.float32[m, 1], numpy.ndarray.flags.writeable], vec: numpy.ndarray[numpy.float64[m, 1]]
) -> None:
    """
...
def mju_negQuat(
    res: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable], quat: numpy.ndarray[numpy.float64[4, 1]]
) -> None:
    """
...
def mju_quat2Mat(
    res: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable], quat: numpy.ndarray[numpy.float64[4, 1]]
) -> None:
    """
...
def mju_quatZ2Vec(
    quat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable], vec: numpy.ndarray[numpy.float64[3, 1]]
) -> None:
    """
...
def mjv_applyPerturbForce(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, pert: mujoco._structs.MjvPerturb
) -> None:
    """
...
def mjv_applyPerturbPose(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, pert: mujoco._structs.MjvPerturb, flg_paused: int
) -> None:
    """
...
def mjv_updateCamera(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, cam: mujoco._structs.MjvCamera, scn: mujoco._structs.MjvScene
) -> None:
    """
    Update camera.
    """
