...
app = flask.Flask(
    __name__, static_folder="static", static_url_path="/corrector/static"
)
    ...
    return flask.jsonify(
        {
            ...
            "radiusIncreaseFactor": app.config["arguments"][
...
@click.option(
    ...
    default=2,
    help="Factor with which the radius gets increased in GUI",
    show_default=True,
)
