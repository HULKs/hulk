...
import tfrecord.feature_pb2 as feature__pb2
...
_EXAMPLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="features",
            full_name="tensorflow.Example.features",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SEQUENCEEXAMPLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="context",
            full_name="tensorflow.SequenceExample.context",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="feature_lists",
            full_name="tensorflow.SequenceExample.feature_lists",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SEQUENCEEXAMPLE.fields_by_name[
    "feature_lists"
].message_type = feature__pb2._FEATURELISTS
