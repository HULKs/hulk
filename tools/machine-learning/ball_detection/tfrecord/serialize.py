...
def serialize(
    is_positive=False,
    circle: typing.Tuple[float, float, float] = (0, 0, 0),
    data_shape: typing.Tuple[int, int, int] = (0, 0, 0),
    data: typing.Iterable[int] = [],
):
    ...
    example.features.feature["dataShape"].int64_list.value.append(data_shape[0])
    example.features.feature["dataShape"].int64_list.value.append(data_shape[1])
    example.features.feature["dataShape"].int64_list.value.append(data_shape[2])
    ...
    return (
        length_bytes
        + masked_crc32_of_length_bytes
        + data_bytes
        + masked_crc32_of_data_bytes
    )
