...
class PopulationPad(Pad):
    def __init__(
        ...
        super(PopulationPad, self).__init__(
            x, y, from_line, from_col, to_line, to_col, stdscr, use_curses
        )
    ...
    def print(self, population):
        ...
        for ind in population.members:
            self.put_line(
                ind.name[:18].ljust(18, " ")
                + " "
                + str(ind.fitness)[:6].ljust(6, " ")
                + "    "
                + ("%.4f" % ind.cost)[:6].ljust(6, " ")
                + "    "
...
class MemberPad(Pad):
    ...
    def print(self, member, nn_type, final_layer_neurons):
        ...
        self.put_line(
            ...
            + str(member.genes["initial_learning_rate"])
        )
        self.put_line(
            "Learning rate factor per epoch: "
            + str(member.genes["learning_rate_factor_per_epoch"])
        )
        self.put_line("Cost: " + ("%.4f" % member.cost))
        self.put_line("")
        ...
        self.put_line(
            ""
            + str(final_layer_neurons).rjust(5, " ")
            + "   "
            + str(bn).ljust(8, " ")
            + "  "
            + act.ljust(11, " ")
...
class ProgressionPad(Pad):
    def __init__(
        ...
        super(ProgressionPad, self).__init__(
            x, y, from_line, from_col, to_line, to_col, stdscr, use_curses
        )
    ...
    def print(self, progression):
        ...
        self.put_line(
            "  gen #pop name               " + "fitness   cost      score"
        )
