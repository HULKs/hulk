...
///
/// Values support equality and monotonic recency comparisons within one [`Graph`]. A changed
/// revision means consumers should resync from [`Graph::view`] or [`Graph::snapshot`]. Do not
/// treat revisions as stable event counts or as proof that the distributed graph is complete.
