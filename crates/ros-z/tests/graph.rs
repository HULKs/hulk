...
use ros_z::{
    ...
    entity::{EndpointEntity, EndpointKind, Entity, EntityKind, NodeKey},
    msg::Service,
...
mod tests {
    ...
    async fn test_get_topic_names_and_types() -> Result<()> {
        ...
        let _pub = node.publisher::<RosString>(&topic_name).build().await?;
        assert!(
    ...
    async fn test_count_subscribers() -> Result<()> {
        ...
        // Create a subscriber
        let _sub = node.subscriber::<RosString>(topic_name).build().await?;
    ...
    async fn test_graph_query_functions() -> Result<()> {
        ...
        // Create a publisher
        let pub_handle = node.publisher::<RosString>(&topic_name).build().await?;
        ...
        // Create a subscriber
        let sub_handle = node.subscriber::<RosString>(&topic_name).build().await?;
    ...
    async fn test_multi_node_publishers() -> Result<()> {
        ...
        let _pub1 = node1.publisher::<RosString>(&topic_name).build().await?;
        let _pub2 = node2.publisher::<RosString>(&topic_name).build().await?;
    ...
    async fn test_multi_node_subscribers() -> Result<()> {
        ...
        let _sub1 = node1.subscriber::<RosString>(&topic_name).build().await?;
        let _sub2 = node2.subscriber::<RosString>(&topic_name).build().await?;
