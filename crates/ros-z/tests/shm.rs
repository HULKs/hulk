...
async fn test_shm_pubsub_large_message() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("shm_test_topic")
        .build()
        .await
        .expect("Failed to create publisher");

    let subscriber = node
        .subscriber::<ByteMultiArray>("shm_test_topic")
        .build()
        .await
...
async fn test_shm_pubsub_small_message() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("small_topic")
        .build()
        .await
        .expect("Failed to create publisher");

    let subscriber = node
        .subscriber::<ByteMultiArray>("small_topic")
        .build()
        .await
        .expect("Failed to create subscriber");
...
async fn test_shm_threshold_boundary() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("boundary_topic")
        .build()
        .await
        .expect("Failed to create publisher");

    let subscriber = node
        .subscriber::<ByteMultiArray>("boundary_topic")
        .build()
        .await
        .expect("Failed to create subscriber");
...
async fn test_shm_config_hierarchy_node_override() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("hierarchy_topic")
        .build()
        .await
        .expect("Failed to create publisher");

    let subscriber = node
        .subscriber::<ByteMultiArray>("hierarchy_topic")
        .build()
        .await
        .expect("Failed to create subscriber");
...
async fn test_without_shm() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("no_shm_topic")
    ...
    let subscriber = node
        .subscriber::<ByteMultiArray>("no_shm_topic")
        .build()
        .await
        .expect("Failed to create subscriber");
...
async fn test_publisher_shm_override() {
    ...
    let publisher = node
        .publisher::<ByteMultiArray>("pub_shm_topic")
    ...
    let subscriber = node
        .subscriber::<ByteMultiArray>("pub_shm_topic")
        .build()
        .await
        .expect("Failed to create subscriber");
...
async fn test_multiple_publishers_different_thresholds() {
    ...
    let pub1 = node
        .publisher::<ByteMultiArray>("topic1")
        .build()
        .await
    ...
    let pub2 = node
        .publisher::<ByteMultiArray>("topic2")
    ...
    let sub1 = node
        .subscriber::<ByteMultiArray>("topic1")
        .build()
        .await
        .expect("Failed to create subscriber 1");

    let sub2 = node
        .subscriber::<ByteMultiArray>("topic2")
        .build()
        .await
