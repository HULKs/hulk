...
pub struct NewContext {
    pub low_pass_filter_coefficient: Parameter<f32, "control/sonar_filter/low_pass_filter_coefficient">,
    pub maximal_detectable_distance: Parameter<f32, "control/sonar_filter/maximal_detectable_distance">,
