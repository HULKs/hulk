use framework::{
    MainOutput, PerceptionInput, AdditionalOutput, PersistentState, OptionalInput, HistoricInput, Parameter
};
...
pub struct NewContext {
    pub circle_measurement_noise: Parameter<Vector2<f32>, "control/localization/circle_measurement_noise">,
    pub field_dimensions: Parameter<FieldDimensions, "field_dimensions">,
    pub good_matching_threshold: Parameter<f32, "control/localization/good_matching_threshold">,
    pub gradient_convergence_threshold: Parameter<f32, "control/localization/gradient_convergence_threshold">,
    pub gradient_descent_step_size: Parameter<f32, "control/localization/gradient_descent_step_size">,
    pub hypothesis_prediction_score_reduction_factor: Parameter<f32, "control/localization/hypothesis_prediction_score_reduction_factor">,
    pub hypothesis_retain_factor: Parameter<f32, "control/localization/hypothesis_retain_factor">,
    pub hypothesis_score_base_increase: Parameter<f32, "control/localization/hypothesis_score_base_increase">,
    pub initial_hypothesis_covariance: Parameter<Matrix3<f32>, "control/localization/initial_hypothesis_covariance">,
    ...
    pub line_length_acceptance_factor: Parameter<f32, "control/localization/line_length_acceptance_factor">,
    pub line_measurement_noise: Parameter<Vector2<f32>, "control/localization/line_measurement_noise">,
    pub maximum_amount_of_gradient_descent_iterations: Parameter<usize, "control/localization/maximum_amount_of_gradient_descent_iterations">,
    pub maximum_amount_of_outer_iterations: Parameter<usize, "control/localization/maximum_amount_of_outer_iterations">,
...
pub struct CycleContext {
    ...
    pub measured_lines_in_field: AdditionalOutput<Vec<Line2>, "localization/measured_lines_in_field">,
