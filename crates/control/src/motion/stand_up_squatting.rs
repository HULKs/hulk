...
pub struct MainOutputs {
    pub stand_up_squatting_positions: MainOutput<Joints<f32>>,
    pub stand_up_squatting_estimated_remaining_duration: MainOutput<Option<Duration>>,
}

impl StandUpSquatting {
    ...
    pub fn cycle(&mut self, context: CycleContext) -> Result<MainOutputs> {
        ...
        Ok(MainOutputs {
            stand_up_squatting_positions: self.interpolator.value().into(),
            stand_up_squatting_estimated_remaining_duration:
                stand_up_back_estimated_remaining_duration.into(),
        })
    }
}
