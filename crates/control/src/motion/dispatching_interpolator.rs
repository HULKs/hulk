    ...
    pub fn cycle(&mut self, mut context: CycleContext) -> Result<MainOutputs> {
        ...
        if interpolator_reset_required {
            let target_position = match dispatching_motion {
                ...
                MotionType::KeeperJumpLeft => context.keeper_jump_left_joints_command.positions,
                MotionType::KeeperJumpRight => context.keeper_jump_right_joints_command.positions,
