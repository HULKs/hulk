...
use hsl_network_messages::{GameState, HulkMessage, PlayerNumber, VisualRefereeMessage};
use types::{
...
pub struct CycleContext {
    ...
    referee_pose_kind: PerceptionInput<Option<PoseKind>, "Hydra", "referee_pose_kind?">,
