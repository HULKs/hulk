...
pub struct NewContext {
    pub fall_state_estimation: Parameter<crate::framework::configuration::FallStateEstimation, "control/fall_state_estimation">,
}

#[context]
pub struct CycleContext {
    pub backward_gravitational_difference: AdditionalOutput<f32, "backward_gravitational_difference">,
    pub filtered_angular_velocity: AdditionalOutput<Vector3<f32>, "filtered_angular_velocity">,
    pub filtered_linear_acceleration: AdditionalOutput<Vector3<f32>, "filtered_linear_acceleration">,
