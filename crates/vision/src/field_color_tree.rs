...
if features.green_luminance <= 200 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.365 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_chromaticity <= 0.365 {
if features.blue_chromaticity <= 0.365 {
if features.red_luminance <= 142 {
if features.blue_luminance <= 176 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_luminance <= 232 {
...
if features.green_chromaticity <= 0.346 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_luminance <= 181 {
Intensity::Low
} else {
...
if features.blue_chromaticity <= 0.376 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.322 {
Intensity::High
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.325 {
Intensity::High
} else {
if features.blue_luminance <= 238 {
Intensity::High
} else {
if features.blue_luminance <= 240 {
...
if features.green_chromaticity <= 0.327 {
...
if features.green_luminance <= 202 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_luminance <= 194 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_luminance <= 206 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.388 {
if features.blue_luminance <= 152 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_luminance <= 151 {
if features.saturation <= 57 {
if features.red_chromaticity <= 0.304 {
if features.saturation <= 55 {
Intensity::Low
...
if features.green_luminance <= 207 {
Intensity::High
} else {
Intensity::Low
}
...
if features.red_chromaticity <= 0.126 {
Intensity::Low
} else {
Intensity::High
}
...
if features.blue_chromaticity <= 0.449 {
...
if features.red_chromaticity <= 0.406 {
Intensity::High
} else {
Intensity::Low
}
...
if features.blue_difference <= 94 {
Intensity::High
} else {
Intensity::High
}
...
if features.red_difference <= 117 {
if features.green_chromaticity <= 0.598 {
...
if features.blue_difference <= 114 {
if features.blue_chromaticity <= 0.105 {
if features.blue_chromaticity <= 0.050 {
Intensity::High
} else {
if features.blue_chromaticity <= 0.051 {
Intensity::High
} else {
...
if features.green_chromaticity <= 0.823 {
if features.intensity <= 10 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_difference <= 112 {
if features.blue_chromaticity <= 0.118 {
Intensity::High
} else {
if features.luminance <= 44 {
...
if features.red_chromaticity <= 0.402 {
if features.red_chromaticity <= 0.402 {
Intensity::Low
} else {
Intensity::High
...
if features.green_luminance <= 47 {
if features.green_chromaticity <= 0.814 {
...
if features.blue_luminance <= 28 {
if features.blue_chromaticity <= 0.418 {
if features.hue <= 84 {
Intensity::Low
} else {
Intensity::High
...
if features.value <= 33 {
if features.blue_chromaticity <= 0.407 {
Intensity::High
} else {
Intensity::Low
}
...
if features.green_luminance <= 88 {
if features.red_difference <= 105 {
Intensity::Low
} else {
Intensity::High
...
if features.blue_luminance <= 58 {
if features.red_chromaticity <= 0.163 {
Intensity::High
} else {
if features.saturation <= 155 {
Intensity::High
...
if features.red_chromaticity <= 0.139 {
Intensity::High
} else {
if features.red_chromaticity <= 0.139 {
Intensity::Low
...
if features.green_chromaticity <= 0.822 {
if features.red_chromaticity <= 0.082 {
if features.red_luminance <= 2 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.red_chromaticity <= 0.144 {
...
if features.red_chromaticity <= 0.088 {
Intensity::Low
} else {
Intensity::High
}
...
if features.blue_chromaticity <= 0.261 {
if features.blue_chromaticity <= 0.242 {
if features.green_chromaticity <= 0.712 {
Intensity::Low
} else {
Intensity::High
}
...
if features.red_chromaticity <= 0.085 {
...
if features.red_difference <= 115 {
if features.blue_chromaticity <= 0.275 {
if features.green_chromaticity <= 0.873 {
if features.blue_luminance <= 19 {
...
if features.green_chromaticity <= 0.611 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.red_chromaticity <= 0.130 {
if features.red_chromaticity <= 0.074 {
...
if features.saturation <= 198 {
if features.green_chromaticity <= 0.637 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.734 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_chromaticity <= 0.065 {
Intensity::Low
} else {
if features.red_luminance <= 11 {
Intensity::Low
...
if features.green_luminance <= 29 {
if features.green_chromaticity <= 0.475 {
if features.blue_chromaticity <= 0.038 {
Intensity::Low
} else {
Intensity::Low
}
