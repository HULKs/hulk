...
if features.hue <= 35 {
if features.green_luminance <= 204 {
if features.red_luminance <= 192 {
Intensity::Low
} else {
Intensity::High
}
...
if features.red_difference <= 130 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_chromaticity <= 0.392 {
...
if features.red_difference <= 129 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.red_chromaticity <= 0.119 {
Intensity::High
} else {
if features.blue_difference <= 111 {
Intensity::High
...
if features.green_chromaticity <= 0.891 {
if features.blue_difference <= 117 {
Intensity::Low
} else {
Intensity::Low
...
if features.blue_chromaticity <= 0.139 {
Intensity::High
} else {
Intensity::High
}
...
if features.blue_chromaticity <= 0.077 {
if features.blue_difference <= 115 {
...
if features.blue_chromaticity <= 0.033 {
Intensity::High
} else {
Intensity::Low
}
...
if features.blue_chromaticity <= 0.016 {
Intensity::Low
} else {
Intensity::High
}
...
if features.red_chromaticity <= 0.388 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.red_chromaticity <= 0.038 {
if features.value <= 26 {
Intensity::High
} else {
if features.red_difference <= 114 {
...
if features.red_chromaticity <= 0.059 {
Intensity::Low
} else {
Intensity::High
}
...
if features.red_chromaticity <= 0.035 {
if features.red_chromaticity <= 0.010 {
if features.green_chromaticity <= 0.706 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.blue_chromaticity <= 0.398 {
Intensity::Low
} else {
Intensity::Low
}
...
if features.green_chromaticity <= 0.689 {
if features.red_difference <= 115 {
Intensity::Low
} else {
if features.red_difference <= 116 {
...
if features.green_chromaticity <= 0.605 {
if features.hue <= 63 {
Intensity::High
} else {
Intensity::High
...
if features.green_luminance <= 32 {
if features.green_luminance <= 27 {
if features.blue_chromaticity <= 0.015 {
Intensity::Low
} else {
...
if features.red_luminance <= 14 {
if features.green_chromaticity <= 0.671 {
if features.saturation <= 196 {
if features.intensity <= 17 {
Intensity::Low
} else {
...
if features.blue_chromaticity <= 0.098 {
Intensity::Low
} else {
Intensity::Low
}
