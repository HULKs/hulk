...
use iter_if::iter_if;
use map_segments::{HorizontalMapping, VerticalMapping, map_segments};
...
pub struct CycleContext {
    ...
    camera_matrix: RequiredInput<Option<CameraMatrix>, "WorldState", "camera_matrix?">,
    filtered_segments: Input<FilteredSegments, "filtered_segments">,
    image: Input<YCbCr422Image, "ycbcr422_image">,
}
