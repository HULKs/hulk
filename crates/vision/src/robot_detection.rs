use framework::{
    AdditionalOutput, RequiredInput, MainOutput, Parameter
};
...
pub struct NewContext {
    pub amount_of_segments_factor: Parameter<f32, "$this_cycler/robot_detection/amount_of_segments_factor">,
    ...
    pub cluster_distance_score_range: Parameter<Range<f32>, "$this_cycler/robot_detection/cluster_distance_score_range">,
    ...
    pub luminance_score_exponent: Parameter<f32, "$this_cycler/robot_detection/luminance_score_exponent">,
    pub maximum_cluster_distance: Parameter<f32, "$this_cycler/robot_detection/maximum_cluster_distance">,
    pub minimum_cluster_score: Parameter<f32, "$this_cycler/robot_detection/minimum_cluster_score">,
    pub minimum_consecutive_segments: Parameter<usize, "$this_cycler/robot_detection/minimum_consecutive_segments">,
}

#[context]
pub struct CycleContext {
    pub cluster_cones: AdditionalOutput<Vec<ClusterCone>, "robot_detection/cluster_cones">,
    pub cluster_points_in_pixel: AdditionalOutput<Vec<ScoredClusterPoint>, "robot_detection/cluster_points_in_pixel">,
    pub clustered_cluster_points_in_ground: AdditionalOutput<Vec<Vec<ScoredClusterPoint>>, "robot_detection/clustered_cluster_points_in_ground">,
