...
pub struct CycleContext {
    pub cluster_cones: AdditionalOutput<Vec<ClusterCone>, "feet_detection.cluster_cones">,
    pub cluster_points_in_pixel:
        AdditionalOutput<Vec<ScoredClusterPoint>, "feet_detection.cluster_points_in_pixel">,
    pub clustered_cluster_points_in_ground: AdditionalOutput<
        Vec<Vec<ScoredClusterPoint>>,
        "feet_detection.clustered_cluster_points_in_ground",
    >,

    pub amount_of_segments_factor:
        Parameter<f32, "feet_detection.$cycler_instance.amount_of_segments_factor">,
    pub amount_score_exponent:
        Parameter<f32, "feet_detection.$cycler_instance.amount_score_exponent">,
    pub cluster_cone_radius: Parameter<f32, "feet_detection.$cycler_instance.cluster_cone_radius">,
    pub cluster_distance_score_range:
        Parameter<Range<f32>, "feet_detection.$cycler_instance.cluster_distance_score_range">,
    pub detection_box_width: Parameter<f32, "feet_detection.$cycler_instance.detection_box_width">,
    pub enable: Parameter<bool, "feet_detection.$cycler_instance.enable">,
    pub field_dimensions: Parameter<FieldDimensions, "field_dimensions">,
    pub ignore_ball_segments:
        Parameter<bool, "feet_detection.$cycler_instance.ignore_ball_segments">,
    pub ignore_line_segments:
        Parameter<bool, "feet_detection.$cycler_instance.ignore_line_segments">,
    pub luminance_score_exponent:
        Parameter<f32, "feet_detection.$cycler_instance.luminance_score_exponent">,
    ...
    pub minimum_cluster_score:
        Parameter<f32, "feet_detection.$cycler_instance.minimum_cluster_score">,
...
pub struct MainOutputs {
    pub detected_feet: MainOutput<Option<DetectedFeet>>,
}
...
impl FeetDetection {
    ...
    pub fn cycle(&mut self, mut context: CycleContext) -> Result<MainOutputs> {
        ...
        Ok(MainOutputs {
            detected_feet: Some(DetectedFeet {
                positions: clusters_in_ground,
            })
            .into(),
        })
    }
