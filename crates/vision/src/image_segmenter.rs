...
pub struct NewContext {
    pub vertical_edge_detection_source: Parameter<EdgeDetectionSource, "$this_cycler/image_segmenter/vertical_edge_detection_source">,
    pub vertical_edge_threshold: Parameter<i16, "$this_cycler/image_segmenter/vertical_edge_threshold">,
    pub vertical_median_mode: Parameter<MedianMode, "$this_cycler/image_segmenter/vertical_median_mode">,
}
