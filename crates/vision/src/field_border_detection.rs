...
pub struct NewContext {
    ...
    pub first_line_association_distance:
        Parameter<f32, "$this_cycler/field_border_detection/first_line_association_distance">,
    pub horizon_margin: Parameter<f32, "$this_cycler/field_border_detection/horizon_margin">,
    pub min_points_per_line:
        Parameter<usize, "$this_cycler/field_border_detection/min_points_per_line">,
    pub second_line_association_distance:
        Parameter<f32, "$this_cycler/field_border_detection/second_line_association_distance">,
}
