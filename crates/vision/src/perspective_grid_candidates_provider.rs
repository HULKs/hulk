...
pub struct NewContext {
    ...
    pub fallback_radius:
        Parameter<f32, "$this_cycler/perspective_grid_candidates_provider/fallback_radius">,
    pub minimum_radius:
        Parameter<f32, "$this_cycler/perspective_grid_candidates_provider/minimum_radius">,
}
