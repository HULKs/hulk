...
impl SafePoseChecker {
    ...
    pub fn cycle(&mut self, mut context: CycleContext<impl TimeInterface>) -> Result<MainOutputs> {
        ...
        context
            .linear_accelerations_difference_to_safe
            .fill_if_subscribed(|| {
                context.imu_state.linear_acceleration
                    - context.prep_mode_imu_state.linear_acceleration
            });
        context
            .angular_velocities_difference_to_safe
            .fill_if_subscribed(|| {
                context.imu_state.angular_velocity - context.prep_mode_imu_state.angular_velocity
            });
