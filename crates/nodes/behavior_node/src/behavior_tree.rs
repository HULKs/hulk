...
macro_rules! action {
    ($func:expr) => {
        $crate::behavior_tree::Node::Action{
            name: stringify!($func),
            action: Box::new($func)
        }
    };
...
macro_rules! condition {
    ($func:ident) => {
        $crate::behavior_tree::Node::Condition {
            name: stringify!($func),
...
macro_rules! negation {
    ($child:expr) => {
        $crate::behavior_tree::Node::Negation {
            name: "Negation",
            child: Box::new($child),
        }
    };
...
macro_rules! selection {
    ($($child:expr),* $(,)?) => {
        $crate::behavior_tree::Node::Selection{
            name: "Selection",
            children: vec![$($child),*]
        }
    };
...
macro_rules! sequence {
    ($($child:expr),* $(,)?) => {
        $crate::behavior_tree::Node::Sequence{
            name: "Sequence",
            children: vec![$($child),*]
        }
    };
...
macro_rules! subtree {
    ($func:expr) => {
        $crate::behavior_tree::Node::Subtree {
