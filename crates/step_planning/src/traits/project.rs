...
impl<Frame> Project<Frame> for Path<'_, Frame> {
    fn project(&self, point: Point2<Frame>) -> Point2<Frame> {
...
impl<Frame> Project<Frame> for PathSegment<Frame> {
    fn project(&self, point: Point2<Frame>) -> Point2<Frame> {
        match self {
...
impl<Frame> Project<Frame> for LineSegment<Frame> {
    fn project(&self, point: Point2<Frame>) -> Point2<Frame> {
...
impl<Frame> Project<Frame> for Arc<Frame> {
    fn project(&self, point: Point2<Frame>) -> Point2<Frame> {
