...
impl Default for TopicInfos {
    fn default() -> Self {
        Self {
            ...
            fall_down: TopicInfo::new("booster/fall_down", "Real-time detection of robot falls"),
            button_event: TopicInfo::new(
                "booster/button_event",
                "Real-time retrieval of backboard button inputs",
            ),
            remote_controller_state: TopicInfo::new(
                "booster/remote_controller_state",
            ...
            rectified_image: TopicInfo::new(
                "booster/rectified_image",
                "SteroenetNode rectified image (base image left camera",
            ),
            image_left_raw: TopicInfo::new(
                "booster/image_left_raw",
                "Real-time acquisition of coordinate transformations between robot joints",
            ),
            image_left_raw_camera_info: TopicInfo::new(
                "booster/image_left_raw/camera_info",
                "Real-time acquisition of coordinate transformations between robot joints",
            ),
        }
    }
...
impl BoosterHardwareInterface {
    pub async fn new(
        ...
        Ok(Self {
            ...
            joint_control_publisher: declare_publisher(&session, &topic_infos.low_state).await?,
