...
namespace DevilSmash
{
  ...
  enum class Role : uint8_t
  {
    ...
    DEFENDER,           /// Defensive player, must not touch the penalty area in most situations
    ...
    LOSER,              /// The guy that lost the ball while dribbling (active during BallSearch)
    SEARCHER,           /// Player that walks around and searches the ball during BallSearch
