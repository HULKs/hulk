...
bool HungarianMethod::breadthFirstAlternatingTreeSearch(HungarianMethod::SimpleQueue<int>& q,
                                                        int& exposedY, int& lastX)
{
...
bool HungarianMethod::searchForExposedX(HungarianMethod::SimpleQueue<int>& q, int& exposedY,
                                        int& lastX)
{
  bool augmentedPathFound = false;
  for (int y = 0; y < n_; y++)
