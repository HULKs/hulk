...
#[parameter(path = $cycler_instance.line_detection.allowed_line_length_in_field, data_type = Range<f32>)]
#[parameter(path = $cycler_instance.line_detection.check_line_segments_projection, data_type = bool)]
#[parameter(path = $cycler_instance.line_detection.check_line_length, data_type = bool)]
#[parameter(path = $cycler_instance.line_detection.check_line_distance, data_type = bool)]
#[parameter(path = $cycler_instance.line_detection.gradient_alignment, data_type = f32)]
#[parameter(path = $cycler_instance.line_detection.maximum_distance_to_robot, data_type = f32)]
#[parameter(path = $cycler_instance.line_detection.maximum_fit_distance_in_pixels, data_type = f32)]
#[parameter(path = $cycler_instance.line_detection.maximum_gap_on_line, data_type = f32)]
#[parameter(path = $cycler_instance.line_detection.maximum_number_of_lines, data_type = usize)]
#[parameter(path = $cycler_instance.line_detection.maximum_projected_segment_length, data_type = f32)]
#[parameter(path = $cycler_instance.line_detection.minimum_number_of_points_on_line, data_type = usize)]
