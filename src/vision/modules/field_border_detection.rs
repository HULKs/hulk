...
#[parameter(path = $cycler_instance.field_border_detection.min_points_per_line, data_type = usize)]
#[parameter(path = $cycler_instance.field_border_detection.angle_threshold, data_type = f32)]
#[parameter(path = $cycler_instance.field_border_detection.first_line_association_distance, data_type = f32)]
#[parameter(path = $cycler_instance.field_border_detection.second_line_association_distance, data_type = f32)]
#[parameter(path = $cycler_instance.field_border_detection.horizon_margin, data_type = f32)]
