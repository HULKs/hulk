...
#[parameter(path = $cycler_instance.robot_detection.enable, data_type = bool)]
#[parameter(path = $cycler_instance.robot_detection.amount_of_segments_factor, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.amount_score_exponent, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.cluster_cone_radius, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.cluster_distance_score_range, data_type = Range<f32>)]
#[parameter(path = $cycler_instance.robot_detection.detection_box_width, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.ignore_ball_segments, data_type = bool)]
#[parameter(path = $cycler_instance.robot_detection.ignore_line_segments, data_type = bool)]
#[parameter(path = $cycler_instance.robot_detection.luminance_score_exponent, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.maximum_cluster_distance, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.minimum_cluster_score, data_type = f32)]
#[parameter(path = $cycler_instance.robot_detection.minimum_consecutive_segments, data_type = usize)]
#[parameter(path = field_dimensions, data_type = FieldDimensions)]
#[additional_output(path = robot_detection.cluster_points_in_pixel, data_type = Vec<ScoredClusterPoint>)]
#[additional_output(path = robot_detection.clustered_cluster_points_in_ground, data_type = Vec<Vec<ScoredClusterPoint>>)]
#[additional_output(path = robot_detection.cluster_cones, data_type = Vec<ClusterCone>)]
#[main_output(data_type = DetectedRobots)]
impl RobotDetection {}
