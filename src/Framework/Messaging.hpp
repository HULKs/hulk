...
public:
  ...
  /**
   * @brief send sends a message via this sender, it will be available at the receiver after this
   * call
...
public:
   ...
   * @param message is filled with the received message
   * @return true iff a message was available
   */
  bool receive(Message& message);
  /**
   * @brief request announces that someone expects that a specific DataType comes out of this
   * receiver
...
public:
  /**
   * @brief DuplexChannel creates data queues, senders and receivers for communication between two
