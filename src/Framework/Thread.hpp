...
public:
   ...
   * @param threadData the thread data for this thread
   */
  explicit ThreadBase(ThreadData& threadData);
  /**
...
public:
   ...
   * @param threadData reference to the thread data for this thread
   */
  explicit Thread(ThreadData& threadData)
    : ThreadBase(threadData)
  {
    factory.use();
  }
