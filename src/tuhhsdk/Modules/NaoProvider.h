...
/// FSR positions
extern const Vector3f FSR_POSITION[FSR_MAX];
...
private:
  ...
  static T interpolate(std::vector<Eigen::Matrix<T, 3, 1>, Eigen::aligned_allocator<Eigen::Matrix<T, 3, 1>>>& src, const T& value);
