...
public:
  ...
  /**
   * @brief getOrientation calculates the current orientation in Euler angles from the internatl
   * state
...
private:
  /**
   * @brief calculateOrientation calculates the (intial) orientation from the external acceleration
   * measurement
  ...
  /**
   * @brief updateOrientationAccel corrects the orientation with the external acceleration
   * measurement
