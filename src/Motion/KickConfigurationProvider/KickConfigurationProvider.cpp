#include "Motion/KickConfigurationProvider/KickConfigurationProvider.hpp"
...
void KickConfigurationProvider::updateOutput()
{
  ...
  kickConfigurationData_->kicks[KickType::NONE] = KickConfiguration();
  kickConfigurationData_->kicks[KickType::FORWARD] = forwardKick_();
  ...
  kickConfigurationData_->inWalkKicks[InWalkKickType::NONE] = InWalkKick();
  kickConfigurationData_->inWalkKicks[InWalkKickType::FORWARD] = inWalkFrontKick_();
  kickConfigurationData_->inWalkKicks[InWalkKickType::TURN] = inWalkTurnKick_();

  // convert things to rad for in walk kicks
  for (auto& inWalkKick : kickConfigurationData_->inWalkKicks)
  {
    inWalkKick.preStep.angle() *= TO_RAD;
    inWalkKick.kickStep.angle() *= TO_RAD;
