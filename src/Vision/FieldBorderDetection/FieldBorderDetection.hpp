...
public:
  ...
  ModuleName name__{"FieldBorderDetection"};
  /**
...
private:
  ...
  /// the maximum number of points already used for the first field border segment which
  /// are above the potential second field border line and therefore outside of the field
  const Parameter<int> maxBorderPointsNotEnclosed_;
