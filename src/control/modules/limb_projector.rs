...
#[parameter(path = control.projected_limbs.torso_bounding_polygon, data_type = Vec<Point3<f32>>)]
#[parameter(path = control.projected_limbs.lower_arm_bounding_polygon, data_type = Vec<Point3<f32>>)]
#[parameter(path = control.projected_limbs.upper_arm_bounding_polygon, data_type = Vec<Point3<f32>>)]
#[parameter(path = control.projected_limbs.knee_bounding_polygon, data_type = Vec<Point3<f32>>)]
#[parameter(path = control.projected_limbs.foot_bounding_polygon, data_type = Vec<Point3<f32>>)]
#[main_output(name = projected_limbs, data_type = ProjectedLimbs)]
impl LimbProjector {}
...
impl LimbProjector {
    ...
    fn cycle(&mut self, context: CycleContext) -> anyhow::Result<MainOutputs> {
        let camera_matrix = &require_some!(context.camera_matrices).bottom;
