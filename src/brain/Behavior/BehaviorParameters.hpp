...
struct BehaviorParameters
{
  BehaviorParameters(const ModuleBase& module)
    ...
    , calibrationHeadPitch(module, "calibrationHeadPitch", [this] { calibrationHeadPitch() *= TO_RAD; })
    ...
    , lookAroundOuterPosition(module, "lookAroundOuterPosition", [this] { lookAroundOuterPosition() *= TO_RAD; })
    , lookAroundYawVelocity(module, "lookAroundYawVelocity", [this] { lookAroundYawVelocity() *= TO_RAD; })
    , debugTargetEnable(module, "debugTargetEnable", [] {})
    , debugTargetRelativePose(module, "debugTargetRelativePose", [this] { debugTargetRelativePose().orientation *= TO_RAD; })
  {
  ...
  /// yaw possition used in between balltrackerHeadPosition yaw
