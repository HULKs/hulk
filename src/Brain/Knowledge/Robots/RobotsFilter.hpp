...
public:
  ...
  {
    Robot(const Vector4f& initialState, const Matrix4f& initialStateCovariance,
  ...
  ModuleName name__{"RobotsFilter"};
  /**
   *@brief The constructor of this class
   */
  explicit RobotsFilter(const ModuleManagerInterface& manager);
...
private:
  ...
  const Parameter<Clock::duration> maxTimeSinceLastUpdate_;
  ...
  const Parameter<Clock::duration> timeKeepRobotInFilter_;
