...
public:
  ...
  ModuleName name__{"SetPlayStrikerActionProvider"};
  /**
...
private:
   ...
   * specific foot)
   */
  void createStrikerAction(KickType kickType, const Vector2f& absTarget,
                           const Vector2f& relBallPosition, int& lastSign, bool forceSign);
  /**
  ...
  /// whether the robot should always kick the ball in a free kick situation
  const Parameter<bool> alwaysKickInFreeKick_;
