...
struct RawTeamPlayer : public Uni::To, public Uni::From
{
  ...
  /// time since the message from the robot has been received
  ...
  Clock::time_point timeWhenBallWasSeen;
  ...
  /// the roles this player would assign to everyone
  ...
  Clock::time_point timeWhenReachBall;
  /// the estimated time when this mate would reach the ball as striker
  Clock::time_point timeWhenReachBallStriker;
  ...
  /// estimation)
  Clock::time_point timestampLastJumped;
...
public:
  ...
  DataTypeName name__{"RawTeamPlayers"};
