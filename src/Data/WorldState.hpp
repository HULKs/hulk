...
public:
  ...
  DataTypeName name__{"WorldState"};
  ...
  void toValue(Uni::Value& value) const override
  {
    ...
    value["robotInGoalBoxArea"] << robotInGoalBoxArea;
    ...
    value["ballInGoalBoxArea"] << ballInGoalBoxArea;
