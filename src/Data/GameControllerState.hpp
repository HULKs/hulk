...
public:
  ...
  DataTypeName name__{"RawGameControllerState"};
  ...
  Clock::time_point timestampOfLastMessage;
  ...
  Clock::time_point gameStateChanged;
  ...
  Clock::time_point setPlayChanged;
...
public:
  /// the name of this DataType
  DataTypeName name__{"GameControllerState"};
