...
{
public:
  explicit Com(const RobotMetrics& robotMetrics);
   ...
   */
  Vector3f getComLLeg(const JointsLegArray<KinematicMatrix>& legKin) const;
   ...
   * @return a vector containing the x,y,z position of the com
   */
  Vector3f getComRLeg(const JointsLegArray<KinematicMatrix>& legKin) const;
   ...
   * @return a vector containing the x,y,z position of the com
   */
  Vector3f getComLArm(const JointsArmArray<KinematicMatrix>& armKin) const;
   ...
   * @return a vector containing the x,y,z position of the com
   */
  Vector3f getComRArm(const JointsArmArray<KinematicMatrix>& armKin) const;
   ...
   * @return a vector containing the x,y,z position of the com
   */
  Vector3f getCom(const JointsArray<float>& jointAngles) const;
   ...
   */
  Vector3f getComBody(const JointsArray<KinematicMatrix>& kinematicMatrices) const;
