...
public:
   ...
   */
  virtual ~FakeDataInterface() = default;
  /**
  ...
  /**
   * @brief generic getter for datatypes for which is getFakeDataInternal is implemented in the
   * according interface.
...
private:
  /**
   * @brief internal generic getter for fake data, should be implemented by the
   * HardwareFakeDataInterface.
   */
